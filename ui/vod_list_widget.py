...
class VODListWidget(QListWidget):
    def __init__(self, parent=None):
        ...
        self.setIconSize(QtCore.QSize(100, 56))  # Define o tamanho do ícone das miniaturas
    ...
    def populate_vods(self, vods):
        ...
        for vod in vods:
            ...
            item.setData(QtCore.Qt.UserRole, vod['link'])  # Armazena o link do VOD no dado do item
            if vod['thumbnail']:
                try:
