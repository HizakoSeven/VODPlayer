...
async def scrape_vods_async(streamer_name, retries=3):
    """
    ...
    for attempt in range(1, retries + 1):
        ...
        try:
            ...
            result = await realizar_scraping(streamer_name)
            logger.debug(
...
async def realizar_scraping(streamer_name):
    """
    ...
    try:
        ...
        m3u8_links = channel_soup.find_all(
            "a", href=re.compile(r"https://api\.vodvod\.top/m3u8/\d+/\d+/index\.m3u8")
        )
